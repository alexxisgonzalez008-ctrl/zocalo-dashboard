        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-lg font-bold text-slate-800">Curva S de Costos (Acumulado)</h3>
                </div>
                <div className="h-[300px] w-full">
                    <ResponsiveContainer width="100%" height="100%">
                        <LineChart data={costCurveData}>
                            ...
                            />
                            <Legend />
                            <Line type="monotone" dataKey="budget" name="Presupuesto" stroke="#94a3b8" strokeWidth={2} dot={false} strokeDasharray="5 5" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h3 className="text-lg font-bold text-slate-800">Gasto por Categoría</h3>
                    </div>
                ...
                <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h3 className="text-lg font-bold text-slate-800">Velocidad (Tareas/Semana)</h3>
                    </div>
                    <div className="h-[250px] w-full">
                        <ResponsiveContainer width="100%" height="100%">
