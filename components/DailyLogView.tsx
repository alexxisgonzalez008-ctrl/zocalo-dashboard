    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 capitalize">{formattedDate}</h2>
                    <p className="text-slate-500 dark:text-slate-400 text-sm">Registro diario de actividad</p>
                </div>
